...
export const createTutorialSteps = (): TutorialStep[] => {
    ...
    return [
        ...
        },
        {
            title: '말을 다 잃으면 승리!',
            description:
                '킹을 제외한 모든 말을 다 잃으면 승리합니다. 백의 폰을 잡아보세요.',
        ...
        },
        {
            ...
            expected: {
                check: (board: Board) => {
                    ...
                    const isKingG8 =
                        !!kingG8 && kingG8.color === 'black' && kingG8.type === 'king';
                    const isKingG7 =
                        !!kingG7 && kingG7.color === 'black' && kingG7.type === 'king';
                    const isRookH7 =
                        !!rookH7 && rookH7.color === 'black' && rookH7.type === 'rook';
        ...
        },
        {
            title: '추가 규칙 : 외딴섬',
            description:
                '내가 움직일 수 있는 말이 킹만 남아도 승리합니다. 흑 폰을 앞으로 이동해보세요.',
        ...
        },
        {
            title: '이제 게임을 하러 가세요!',
            description:
                '이것으로 리버스 체스의 모든 규칙을 살펴봤습니다. 이제 본 게임을 시작해보세요!',
            board: finalBoard,
            expected: {
                check: (board: Board) => {
                    const pieces = board.getAllPieces();
